		...
		<div class="df-modal" role="dialog">
			...
			<div class="df-modal-body">
				...
				{:else if activeModal === 'privacy'}
					...
					<p>Nobody can tell you are reading this, because there is nothing to tell. Every Nowhere page loads from the same <code>/s</code> route, and the content lives in the URL fragment, which your browser keeps local and never sends across the network. Stores, forums, events, drops all arrive the same way. The privacy is structural, not a policy.</p>
